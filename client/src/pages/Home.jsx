        ...
        <div className="homePage-hero">
          ...
          {!userName || userName === 'null' ? 
            ...
            <div className="home-app-intro">
              <h2>Seamless <b> Connections: </b> Transform Your Meetings with Next-Gen Free <b> Video Conferencing!! </b></h2>
          ...
          <>
            <div className="home-app-intro">
                ...
                <h2>Seamless Connections: Transform Your Meetings with Next-Gen Free Video Conferencing!!</h2>
            </div>
          ...
          <div className="about-cards">
            <Card className='about-card-body' >
              <Card.Body>
                ...
                Group collaboration Made Easy!! Transforming scattered voices into one conversation
                </Card.Text>
              </Card.Body>
            </Card>
            <Card className='about-card-body' >
              <Card.Body>
                ...
                <Card.Text className='about-card-text'>
                Plan Meetings Anytime!! Take control of your schedule, not the clock.
                </Card.Text>
              </Card.Body>
            </Card>
            <Card className='about-card-body' >
              <Card.Body>
                ...
                <Card.Text className='about-card-text'>
                Completely Free!! Keep ypur wallet happy while you stay connected.
                </Card.Text>
              </Card.Body>
            </Card>
            <Card className='about-card-body' >
              <Card.Body>
                ...
                <Card.Text className='about-card-text'>
                Keep Knowledge Alive!! Replay, review and learn from every meeting.
                </Card.Text>
              </Card.Body>
            </Card>
            <Card className='about-card-body' >
              <Card.Body>
                ...
                <Card.Text className='about-card-text'>
                Built-In Chat!! Simplifying discussions and fueling collaboration during meetings.
                </Card.Text>
              </Card.Body>
            </Card>
            <Card className='about-card-body' >
              <Card.Body>
                ...
                <Card.Text className='about-card-text'>
                Spped Meet Efficiency!! Connecting ideas faster than ever.
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
